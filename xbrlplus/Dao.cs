...
internal static class Dao
{
    ...
    {
        var command = connection.CreateCommand();
        command.CommandText = "INSERT INTO TConcepts (Id, Uri, NamespaceName, LocalName, Balance, Abstract, PeriodType, Nillable) VALUES ($id, $uri, $namespace, $localname, $balance, $absctract, $periodtype, $nillable)";
